...
class SubscribesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscribe" do
    assert_difference('Subscribe.count') do
      post subscribes_url, params: { subscribe: { item_id: @subscribe.item_id, user_id: @subscribe.user_id } }
    end
  ...
  test "should update subscribe" do
    patch subscribe_url(@subscribe), params: { subscribe: { item_id: @subscribe.item_id, user_id: @subscribe.user_id } }
